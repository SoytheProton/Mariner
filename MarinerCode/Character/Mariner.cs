...
public class Mariner : PlaceholderCharacterModel
{
    ...
    public override RelicPoolModel RelicPool => ModelDb.RelicPool<MarinerRelicPool>();
    public override PotionPoolModel PotionPool => ModelDb.PotionPool<MarinerPotionPool>();
