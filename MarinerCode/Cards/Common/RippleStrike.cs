    ...
    TargetType.AnyEnemy), IAbyssalCard
{
    ...
    protected override async Task OnPlay(
        ...
        CardPlay play)
    {
        await DamageCmd.Attack(DynamicVars.Damage.BaseValue).WithHitCount(DynamicVars.Repeat.IntValue).FromCard(this, play).WithHitFx("vfx/vfx_attack_slash").Execute(choiceContext);
    }
